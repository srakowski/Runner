...
namespace PixelVisionRunner.Data
{
    ...
    public class SfxrSoundData : ISoundData, ISave, ILoad
    {
        ...
        public string SerializeData()
        {
            ...
            sb.Append("\"settings\":\"");
            // TODO: sb.Append(synth.parameters.GetSettingsString());
            sb.Append("\"");
        ...
        {
            // TODO: synth.parameters.startFrequency = frequency;
            // TODO: synth.Play();
        }
        ...
        {
            // TODO: synth.CacheSound();
        }

        public void UpdateSettings(string param)
        {

            // TODO: synth.parameters.SetSettingsString(param);
            CacheSound();
        }

        public string ReadSettings()
        {
            return string.Empty; // TODO: synth.parameters.GetSettingsString();
        }

        public void Mutate(float value = 0.05f)
        {
            // TODO: synth.parameters.Mutate(value);
        }
